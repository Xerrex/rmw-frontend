...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border bg-background/90 
        px-4 py-10 backdrop-blur sm:px-6 lg:px-8 mb-5">
        <div>
          <h1 className="text-4xl font-extrabold tracking-tight bg-gradient-to-r from-primary 
            to-primary/60 bg-clip-text text-transparent">Settings</h1>
