// 'use client';
import { authSignIn } from "@/app/lib/actions_auth";


export default function SignInForm (){

    return(
      <form className="space-y-3" action={authSignIn}>
        <div className="flex flex-col justify-center bg-gray-100 rounded-lg p-8 w-1/4 mx-auto mt-10">
          ...
          <button className="text-white bg-primaryColor hover:bg-primaryColorHover border-0 py-2 px-8 focus:outline-none 
            rounded text-lg">Sign in</button>
          <p className="text-xs text-gray-500 mt-3">Forgot password ? (coming soon)</p>
        </div> 
      </form>
    )
