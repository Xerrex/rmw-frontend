...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-linear-to-br from-slate-50 via-white to-slate-100 
    dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="fixed right-4 top-4 z-50 rounded-full border border-slate-200/80 bg-white/85 p-1 
        shadow-sm backdrop-blur-sm dark:border-slate-700/80 dark:bg-slate-900/80 sm:right-6 sm:top-6">
        <ThemeToggle />
      </div>

      <main className="flex flex-1 flex-col sm:px-6 sm:py-6 lg:px-8 lg:py-8">
        <div className="grid flex-1 grid-cols-1 overflow-hidden rounded-none border border-slate-200/70 bg-white/60 
          shadow-xl shadow-slate-200/50 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-900/40 
          dark:shadow-black/20 lg:grid-cols-2">
          {/* Hero Section - Left */}
          ...
          <div className="flex items-center justify-center bg-white/50 backdrop-blur-sm dark:bg-slate-900/50 
