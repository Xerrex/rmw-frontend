...
function RideCard({ride}) {
  ...
  return (
    <div className="bg-white text-black rounded-lg p-2 m-1 w-full">
      <div className="flex">
        <Image src={RideImage} alt={"car picture"} width={200} height={200}/>
        <div className="flex grow flex-col p-2 bg-gray-300 rounded-lg">
          <p className="text-lg font-semibold">{ride.town_starting}</p>
          <p className="mx-auto text-gray-600">to</p>
      ...
      <div className="flex flex-col space-y-2">
        ...
        <button className="bg-indigo-800 hover:bg-indigo-600 text-white p-4 
